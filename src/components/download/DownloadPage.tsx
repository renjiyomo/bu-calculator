...
const APK_DOWNLOAD_URL = '#'; // e.g. 'https://github.com/yourusername/bu-calculator/releases/latest/download/bueno-calculator.apk'
const APK_VERSION = '1.0.0';
const APK_SIZE_MB = '~4.5 MB';
const GITHUB_RELEASES_URL = 'https://github.com'; // Replace with your repo URL

const isApkReady = APK_DOWNLOAD_URL !== '#';
